...
def call_external_api(tool_name: str) -> Dict[str, Any]:
    ...
    Returns:
        ...
        - forecast_0_temperature (int): Temperature in degrees Celsius for the first period
        - forecast_0_wind (str): Wind conditions for the first period
        - forecast_0_conditions (str): Weather conditions for the first period
        - forecast_1_period (str): Description of the second forecast period
        - forecast_1_temperature (int): Temperature in degrees Celsius for the second period
        - forecast_1_wind (str): Wind conditions for the second period
        - forecast_1_conditions (str): Weather conditions for the second period
    """
    return {
        "forecast_0_period": "Today",
        "forecast_0_temperature": 22,
        "forecast_0_wind": "10 km/h NW",
        "forecast_0_conditions": "Partly cloudy",
        "forecast_1_period": "Tonight",
        "forecast_1_temperature": 15,
        "forecast_1_wind": "5 km/h SE",
        "forecast_1_conditions": "Clear"
    }
...
def weather_mcp_server_get_forecast(latitude: float, longitude: float) -> Dict[str, Any]:
    ...
    Returns:
        ...
        - forecast_periods (List[Dict]): List of forecast period dictionaries, each containing:
    ...
    api_data = call_external_api("weather-mcp-server-get-forecast")
